class ListaTareas{
   constructor(){
      ...
      if (!this.tareas) {
         this.tareas = [
               {tarea: 'Planificar mi primer dia de entrenamiento', completado: false},
         ];
      }
               ...
               <div class="container">
                  <div class="row">
                     <div class="col-md-1 col-xs-1 col-lg-1 col-sm-1 checkbox">
                           <label>
                              <input id="cambiarEstadoTarea" type="checkbox" onchange="listaTareas.cambiarEstadoTarea(${indice})" value="" ${tarea.completado ? 'checked': ''}>
                           </label>
                     </div>
                     ...
                     <div class="col-md-1 col-xs-1 col-lg-1 col-sm-1 area-icono-eliminacion">
                           <a class="" href="/" onclick="listaTareas.eliminarTarea(event, ${indice})">
                              <i id="eliminarTarea" data-id=${indice} class="fas fa-trash-alt icono-eliminacion"></i>
                           </a>
                     </div>
                  </div>
               </div>
